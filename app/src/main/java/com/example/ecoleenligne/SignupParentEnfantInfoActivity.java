...
public class SignupParentEnfantInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                .setDatabaseUrl("https://ecoleenligne-c8cde-default-rtdb.firebaseio.com/")
                .setApiKey("AIzaSyACr3fnvDeYhXhAQNzC-Q-wBRlnU7tfvP4")
                .setApplicationId("ecoleenligne-c8cde").build();
        ...
        if(b!=null)
        {
            ...
            Log.d(TAG, "MDP ENFANT" + motDePasse);
                                    ...
                                    .addOnCompleteListener(SignupParentEnfantInfoActivity.this, new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Eleve eleve= new Eleve(StrinputName, StrinputPrenom,StrinputEmail, motDePasse, StrNiveau,StrAbonnement,StrFormule );
    ...
    protected void sendEmail(String Destination,ArrayList<EnfantInfo> ListEnfantLogin) {
        ...
        {
            LISTEMail=LISTEMail.concat(ListEnfantLogin.get(i).getPrenom()+"."+ListEnfantLogin.get(i).getNom()+"@EcoleEnLigne.com <br/>");
        }
        String fromEmail = "Ecole.En.Ligne2021@gmail.com";
        String fromPassword = "HMIN205-2021";
        String toEmails =Destination;
        List toEmailList = Arrays.asList(toEmails
                .split("\\s*,\\s*"));
        Log.i("SendMailActivity", "To List: " + toEmailList);
        String emailSubject = "Creation de compte pour vos enfants";
        String emailBody = "<p>Bienvenue sur EcoleEnLigne, </p>\n " +
