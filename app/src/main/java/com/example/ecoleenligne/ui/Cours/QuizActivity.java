        ...
        DocumentModules.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    Log.w(TAG  , "I am in module"+"----------------------------------------------------------------------------------------------"+NomModule);
                                                                                        ...
                                                                                        bvalider.setOnClickListener(new View.OnClickListener() {
                                                                                            ...
                                                                                            public void onClick(View v) {
                                                                                                ...
                                                                                                if(!checkQuestion1() || !checkQuestion2()|| !checkQuestion3()|| !checkQuestion4()|| !checkQuestion5()|| !checkQuestion6()){
                                                                                                    Toast.makeText(getApplicationContext(), "Veuillez répondre à toutes les questions ;) ", Toast.LENGTH_SHORT).show();
                                                                                                }else {
                                                                                                    ...
                                                                                                    Log.d("ma note", String.valueOf(resultatNote));
